#ifndef _SHADERGEOPROGRAM_H_
#define _SHADERGEOPROGRAM_H_
...
{	
   ...
   /*
    *
    * This class is a modified version of the ShaderProgram class, with support for geometry shaders.
...
class ShaderGeoProgram
{
    class ShaderInfo
    {
        friend class ShaderGeoProgram;
    private:
...
public:
     ...
     * \param geoShaderFile the file for the source code for the geometry
     *        shader. This file must be placed within the resources of this
     *        project for portability purposes.
     * \throws runtime_error if any error is encountered
     */
    void createProgram(string vertShaderFile,string fragShaderFile, string geoShaderFile)
    {
        ...
        shaders[2] = ShaderInfo(GL_GEOMETRY_SHADER,geoShaderFile,-1);
