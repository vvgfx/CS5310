#ifndef _AMBIENTRENDERER_H_
#define _AMBIENTRENDERER_H_
...
namespace sgraph
{
     ...
     *
     */
    class AmbientRenderer : public SGNodeVisitor
    {
    public:
        /**
         * @brief Construct a new AmbientRenderer object
         *
         ...
         */
        AmbientRenderer(stack<glm::mat4> &mv, map<string, util::ObjectInstance *> &os, util::ShaderLocationsVault &shaderLocations)
        ...
        void visitLeafNode(LeafNode *leafNode)
        {
            ...
            glUniform3fv(shaderLocations.getLocation("albedo"), 1, glm::value_ptr(leafMat.getAlbedo()));
            glUniform1f(shaderLocations.getLocation("ao"), leafMat.getAO());
