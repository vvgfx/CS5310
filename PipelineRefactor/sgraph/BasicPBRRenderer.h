#ifndef _BASICPBRRENDERER_H_
#define _BASICPBRRENDERER_H_
...
namespace sgraph {
     ...
     * 
     */
    class BasicPBRRenderer: public SGNodeVisitor {
        public:
        /**
         * @brief Construct a new BasicPBRRenderer object
         * 
         ...
         */
        BasicPBRRenderer(stack<glm::mat4>& mv,map<string,util::ObjectInstance *>& os,util::ShaderLocationsVault& shaderLocations) 
            : modelview(mv)
            , objects(os) {
