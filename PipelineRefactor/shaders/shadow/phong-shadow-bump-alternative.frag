...
//It's different from the phong-shadow-bump fragment shader in that it converts all the texture values
//to the view co-ordinate system rather than convert all the lights to the tangent co-ordinate space.
void main()
{
    ...
    mat3 tbn = mat3(tempTangent, tempBitangent, tempNormal); // this will convert from tangent space to view space
