#ifndef _SHADOWVOLUMEBUMPMAPPINGPIPELINE_H_
#define _SHADOWVOLUMEBUMPMAPPINGPIPELINE_H_
...
#include "../sgraph/NormalGLScenegraphRenderer.h"
#include "TangentComputer.h"

namespace pipeline
{
    /**
     * An implementation the pipeline interface. This pipeline features lights (directional and spotlights), textures, shadow volumes and bump mapping.
     * To use this pipeline, initalize it using init() and draw a single frame using drawFrame()
     */
    class ShadowVolumeBumpMappingPipeline : public AbstractPipeline
    {
     ...
     */
    void ShadowVolumeBumpMappingPipeline::init(map<string, util::PolygonMesh<VertexAttrib>> &meshes, map<string, util::TextureImage *> &texMap, glm::mat4 &proj)
    {
        ...
        initTextures(texMap);
        renderer = new sgraph::NormalGLScenegraphRenderer(modelview, objects, renderShaderLocations, textureIdMap);
    ...
    void ShadowVolumeBumpMappingPipeline::addMesh(string objectName, util::PolygonMesh<VertexAttrib>& mesh)
    {
     ...
     */
    void ShadowVolumeBumpMappingPipeline::drawFrame(sgraph::IScenegraph *scenegraph, glm::mat4 &viewMat)
    {
        if (!initialized)
...
#pragma endregion
     ...
     */
    void ShadowVolumeBumpMappingPipeline::depthPass(sgraph::IScenegraph *scenegraph, glm::mat4 &viewMat)
    {
     ...
     */
    void ShadowVolumeBumpMappingPipeline::shadowStencilPass(sgraph::IScenegraph *scenegraph, glm::mat4 &viewMat, int lightIndex)
    {
     ...
     */
    void ShadowVolumeBumpMappingPipeline::renderObjectPass(sgraph::IScenegraph *scenegraph, glm::mat4 &viewMat, int lightIndex)
    {
     ...
     */
    void ShadowVolumeBumpMappingPipeline::ambientPass(sgraph::IScenegraph *scenegraph, glm::mat4 &viewMat)
    {
        ambientProgram.enable();
     ...
     */
    void ShadowVolumeBumpMappingPipeline::initTextures(map<string, util::TextureImage *> &textureMap)
    {
    ...
    void ShadowVolumeBumpMappingPipeline::initLights(sgraph::IScenegraph *scenegraph)
    {
