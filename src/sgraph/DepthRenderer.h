#ifndef _DEPTHRENDERER_H_
#define _DEPTHRENDERER_H_
...
namespace sgraph
{
     ...
     *
     */
    class DepthRenderer : public SGNodeVisitor
    {
    public:
        /**
         * @brief Construct a new DepthRenderer object
         *
         ...
         */
        DepthRenderer(stack<glm::mat4> &mv, map<string, util::ObjectInstance *> &os, util::ShaderLocationsVault &shaderLocations)
        ...
        {
            glUniformMatrix4fv(shaderLocations.getLocation("modelview"), 1, GL_FALSE, glm::value_ptr(modelview.top())); // the depth shaders require only the modelview and projection.
