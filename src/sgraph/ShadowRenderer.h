#ifndef _SHADOWRENDERER_H_
#define _SHADOWRENDERER_H_
...
namespace sgraph
{
     ...
     *
     */
    class ShadowRenderer : public SGNodeVisitor
    {
    public:
        /**
         * @brief Construct a new ShadowRenderer object
         *
         ...
         */
        ShadowRenderer(stack<glm::mat4> &mv, map<string, util::ObjectInstance *> &os, util::ShaderLocationsVault &shaderLocations)
