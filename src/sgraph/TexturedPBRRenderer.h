#ifndef _TEXTUREDPBRRENDERER_H_
#define _TEXTUREDPBRRENDERER_H_
...
namespace sgraph {
     ...
     * to be provided as maps texture maps.
     */
    class TexturedPBRRenderer: public SGNodeVisitor {
        public:
        /**
         * @brief Construct a new TexturedPBRRenderer object
         * 
         ...
         */
        TexturedPBRRenderer(stack<glm::mat4>& mv,map<string,util::ObjectInstance *>& os,util::ShaderLocationsVault& shaderLocations, map<string, unsigned int>& texMap) 
            : modelview(mv)
            , objects(os)
            , textureIdMap(texMap) {
