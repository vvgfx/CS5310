#ifndef _VOXEL_DEBUG_RENDERER_H_
#define _VOXEL_DEBUG_RENDERER_H_
...
namespace sgraph {
     ...
     */
    class VoxelDebugRenderer: public SGNodeVisitor {
        public:
        /**
         * @brief Construct a new VoxelDebugRenderer object
         * 
         ...
         */
        VoxelDebugRenderer(stack<glm::mat4>& mv,map<string,util::ObjectInstance *>& os,util::ShaderLocationsVault& shaderLocations, map<string, unsigned int>& texMap) 
            : modelview(mv)
            , objects(os)
            , textureIdMap(texMap) {
