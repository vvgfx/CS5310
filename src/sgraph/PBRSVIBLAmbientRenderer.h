#ifndef _PBR_IBL_SV_AMBIENT_RENDERER_H_
#define _PBR_IBL_SV_AMBIENT_RENDERER_H_
...
{
    /**
     * Ambient implementation for PBR and IBL (Image Based Lighting) with Shadow Volumes.
     *
     */
    class PBRSVIBLAmbientRenderer : public SGNodeVisitor
    {
    public:
        /**
         * @brief Construct a new PBRSVIBLAmbientRenderer object
         *
         ...
         */
        PBRSVIBLAmbientRenderer(stack<glm::mat4> &mv, map<string, util::ObjectInstance *> &os, util::ShaderLocationsVault &shaderLocations, map<string, unsigned int> &texMap)
        ...
        {
            glUniformMatrix4fv(shaderLocations.getLocation("model"), 1, GL_FALSE, glm::value_ptr(modelview.top()));
            ...
            // textures for albedo, normal, metallic, roughness and ao here
