#ifndef __CIRCLELINE_H__
#define __CIRCLELINE_H__

#include "VertexAttrib.h"
#include <PolygonMesh.h>
#include <GLFW/glfw3.h>

class CircleLine: public util::PolygonMesh<VertexAttrib> {
    public:
    CircleLine(int cx,int cy,int radius);
    ~CircleLine(){}

};

CircleLine::CircleLine(int cx,int cy,int radius) {
